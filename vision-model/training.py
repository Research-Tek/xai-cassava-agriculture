...
# # Cassava Disease Classifier Training
#
# This script is based on this [Starter Notebook](https://www.kaggle.com/code/piantic/train-cassava-starter-using-various-loss-funcs/notebook),
# which provided support for various loss function including Taylor Cross Entropy Loss with LabelSmoothing.
#
# This version adds the VOLO vision transformer model.
...
# save validation folds for later
...
class EarlyStopping():
    ...
    def __call__(self, previous_loss, current_loss):
        if (previous_loss - previous_loss) > self.min_delta:
            self.counter +=1
...
def train_loop(folds, fold):
    ...
    model = CustomVolo(CFG.model_name, pretrained=True)
